...
!(function (t, e) {
        ...
        m = {
            ...
            palette: o('<div class="note-color-palette"/>', function (t, e) {
                for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
                    ...
                    o.push(
                        '<div class="note-color-row">' + a.join("") + "</div>"
                    );
                }
                t.html(o.join("")),
                    e.tooltip &&
        ...
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified &&
                    (R = require.specified("codemirror"));
    var L =
    ...
    function O(t) {
        return (
            !F(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
        );
    }
    var U = z("PRE"),
        j = z("LI");
    ...
    var St = {
        ...
        splitPoint: function (t, e) {
            ...
            var a =
                o &&
                yt(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
    ...
    function Nt(t) {
        var e = function (t, o) {
                ...
                if (St.isText(t)) {
                    ...
                    if (((n = t.childNodes[o] || t), St.isText(n)))
                        return e(n, 0);
                    (o = 0), (i = !1);
                }
    ...
    var Et = (function () {
            ...
            return (
                (e.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            "EndToEnd",
                            Nt({ node: this.ec, offset: this.eo })
                        ),
                        e
                    );
                }),
                ...
                (e.prototype.normalize = function () {
                    var t = function (t, e) {
                            if (
                                ...
                                (St.isVisiblePoint(t) &&
                                    St.isRightEdgePoint(t) &&
                                    !e) ||
                                (St.isVisiblePoint(t) &&
                                    St.isLeftEdgePoint(t) &&
                                    e) ||
                                (St.isVisiblePoint(t) &&
                                    St.isBlock(t.node) &&
                                    St.isEmpty(t.node))
                        ...
                        St.walkPoint(
                            ...
                            function (e) {
                                if (!St.isEditable(e.node)) {
                                    var i;
                                    n
                                        ? (St.isLeftEdgePoint(e) &&
                                              a.push(e.node),
                                          St.isRightEdgePoint(e) &&
                                              x.contains(a, e.node) &&
                                              (i = e.node))
                                        : (i = o
                                              ? St.ancestor(e.node, t)
                                              : e.node),
                                        i && t(i) && s.push(i);
                                }
                            },
                ...
                (e.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    if (St.isParaInline(this.sc) || St.isPara(this.sc))
                        return t;
                    var o;
                    if (St.isInline(t.sc)) {
                ...
                (e.prototype.bookmark = function (t) {
                    return {
                        s: {
                            path: St.makeOffsetPath(t, this.sc),
                            offset: this.so,
                        },
                        e: {
                            path: St.makeOffsetPath(t, this.ec),
                            offset: this.eo,
                        },
                    };
                }),
        ...
        At = {
            ...
            createFromNode: function (t) {
                ...
                return (
                    St.isVoid(e) &&
                        ((o = St.listPrev(e).length - 1), (e = e.parentNode)),
                    St.isBR(n)
                        ? ((i = St.listPrev(n).length - 1), (n = n.parentNode))
                        : St.isVoid(n) &&
                          ((i = St.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
        ...
        Lt = (function () {
            ...
            return (
                ...
                (e.prototype.stylePara = function (e, o) {
                    t.each(
                        e.nodes(St.isPara, { includeAncestor: !0 }),
                        function (e, n) {
                            t(n).css(o);
                        }
                    );
                ...
                (e.prototype.styleNodes = function (e, o) {
                    ...
                    var s = St.makePredByNodeName(n),
                        a = e
                            .nodes(St.isText, { fullyContains: !0 })
                            .map(function (t) {
                                return (
                                    St.singleChildAncestor(t, s) ||
                                    St.wrap(t, n)
                                );
                            });
                    if (i) {
                        ...
                        return a.map(function (e) {
                            ...
                            return (
                                t.each(i, function (t, e) {
                                    St.appendChildNodes(n, e.childNodes),
                                        St.remove(e);
                                }),
                                x.head(o)
                            );
                ...
                (e.prototype.current = function (e) {
                    ...
                    return (
                        (n.anchor =
                            e.isOnAnchor() && St.ancestor(e.sc, St.isAnchor)),
            ...
            return (
                ...
                (e.prototype.wrapList = function (t, e) {
                    ...
                    return (
                        ...
                        r &&
                            (St.appendChildNodes(s, x.from(r.childNodes)),
                            St.remove(r)),
                        t
                    );
                }),
                ...
                (e.prototype.insertParagraph = function (e) {
                    ...
                    if (i) {
                        ...
                        if (
                            ...
                            (r = r.concat(
                                St.listDescendant(n, St.isEmptyAnchor)
                            )),
                                t.each(r, function (t, e) {
                                    St.remove(e);
                                }),
            ...
            function u(t) {
                switch (e) {
                    case Dt.where.Column:
                        if (t.isColSpan)
                            return Dt.resultAction.SubtractSpanCount;
                        break;
                    case Dt.where.Row:
                    ...
                    (this.insertNode = this.wrapCommand(function (e) {
                        if (!o.isLimited(t(e).text().length)) {
                            o.createRange().insertNode(e),
                                At.createFromNodeAfter(e).select();
                        }
                    })),
            ...
            return (
                (e.prototype.initialize = function () {
                    ...
                    this.$editable
                        ...
                        this.$editable.html(
                            St.html(this.$note) || St.emptyPara
                        ),
                        this.$editable.on(
                            H.inputEventName,
                            v.debounce(function () {
                    ...
                    return (
                        ...
                        (void 0 === e ||
                            !(
                                ...
                                e.metaKey ||
                                x.contains(
                                    [Tt.code.BACKSPACE, Tt.code.DELETE],
                                    e.keyCode
                                )
                            )) &&
            ...
            return (
                ...
                (t.prototype.activate = function () {
                    ...
                    if (
                        ...
                        var e = Ft.fromTextArea(
                            this.$codable[0],
                            this.options.codemirror
                        );
                        if (this.options.codemirror.tern) {
                            var o = new Ft.TernServer(
            ...
            return (
                (e.prototype.initialize = function () {
                    var e = this.options.dialogsInBody
                        ...
                        n =
                            '<button type="submit" href="#" class="btn btn-danger note-btn note-btn-danger note-link-btn" disabled>' +
            ...
            return (
                (e.prototype.initialize = function () {
                    ...
                    var i = [
                        ...
                        r =
                            '<button type="submit" href="#" class="btn btn-danger note-btn note-btn-danger note-image-btn" disabled>' +
            ...
            return (
                (e.prototype.initialize = function () {
                    var t = this.options.dialogsInBody
                        ...
                        o =
                            '<button type="submit" href="#" class="btn btn-danger note-btn note-btn-danger note-video-btn" disabled>' +
        ...
        re = (function () {
            ...
            return (
                ...
                (e.prototype.handleKeyup = function (t) {
                    ...
                    if (
                        !x.contains(
                            [Tt.code.ENTER, Tt.code.UP, Tt.code.DOWN],
                            t.keyCode
                        )
                    ) {
                        var o = this.context
    ...
    t.fn.extend({
        summernote: function () {
            ...
            (i.langInfo = t.extend(
                ...
                (i.tooltip =
                    "auto" === i.tooltip ? !H.isSupportTouch : i.tooltip),
