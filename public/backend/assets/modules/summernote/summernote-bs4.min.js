            ...
            return (
                (e.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            "EndToEnd",
                            Lt({ node: this.ec, offset: this.eo })
                        ),
                        e
                    );
                }),
                ...
                (e.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    if (
                        (i = i.concat(
                            Nt.listNext(o.nextSibling, Nt.isParaInline)
                        )).length
                    ) {
    ...
    var Dt = (function () {
        ...
        Mt = function (t, e, o, n) {
            ...
            (this.getActionList = function () {
                for (
                    var t = e === Mt.where.Row ? i.rowPos : -1,
                        n = e === Mt.where.Column ? i.colPos : -1,
                        a = 0,
                        l = !0;
                    l;
                    ...
                    t
                        ...
                        .then(function (t) {
                            n.beforeCommand(),
                                ...
                                t.show(),
                                Ht.create(n.editable).insertNode(t[0]),
            ...
            function e(e) {
                (this.ui = t.summernote.ui),
                    ...
                    (this.invertedKeyMap = C.invertObject(
                        this.options.keyMap[B.isMac ? "mac" : "pc"]
                    ));
            }
            return (
                        ...
                        .Deferred(function (t) {
                            ...
                            o.ui.onDialogShown(o.$dialog, function () {
                                ...
                                i
                                    ...
                                    .val(e.url),
                                    B.isSupportTouch || i.trigger("focus"),
                                    o.toggleLinkBtn(r, n, i),
                                    o.bindEnterKey(i, r),
                                    o.bindEnterKey(n, r);
                                var c =
                        ...
                        e.ui.onDialogShown(e.$dialog, function () {
                            e.context.triggerEvent("dialog.shown"),
                                ...
                                n
                                    ...
                                    .val(""),
                                B.isSupportTouch || n.trigger("focus"),
                                e.bindEnterKey(n, i);
                        }),
    ...
    t.fn.extend({
        summernote: function () {
            ...
            (i.langInfo = t.extend(
                ...
                (i.tooltip =
                    "auto" === i.tooltip ? !B.isSupportTouch : i.tooltip),
